...
<section
	class="container mx-auto px-6 py-16 md:py-24 lg:py-32 flex flex-col items-center gap-12 text-center lg:flex-row lg:text-left lg:justify-between"
>
	<!-- Profile Image/Avatar -->
	<div class="relative group">
		<div
			class="absolute -inset-1 bg-gradient-to-r from-primary to-accent rounded-full blur-xl opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"
		></div>
		<div
			class="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-surface shadow-2xl"
		>
			<img
